...
import com.github.itnoles.collegesports.model.News;
...
import static com.github.itnoles.collegesports.BuildConfig.NEWS_URL;

class HeadlinesFragment extends ListFragment implements LoaderManager.LoaderCallbacks<List<News>> {
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        if (mDualPane) {
            ...
            if (mShownCheckPosition != position) {
                ...
                BrowserDetailFragment df = BrowserDetailFragment.newInstance(news.getLink());
