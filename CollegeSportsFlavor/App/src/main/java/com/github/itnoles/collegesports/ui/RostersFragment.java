...
import com.github.itnoles.collegesports.RostersTextView;
import com.github.itnoles.collegesports.ViewHolder;
import com.github.itnoles.collegesports.XMLContentLoader;
import com.github.itnoles.collegesports.model.Rosters;
...
import static com.github.itnoles.collegesports.BuildConfig.ROSTER_URL;

class RostersFragment extends ListFragment implements LoaderManager.LoaderCallbacks<List<Rosters>>, SearchView.OnQueryTextListener {
    ...
    private class RostersListAdapter extends ArrayAdapter<Rosters> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            full_name.setText(item.getFirstName(), item.getLastName());
